...
export default function Sidebar_general() {
  ...
  const closediv = () => {
    ...
    if (document.getElementsByClassName("res-form")[0]) {
      ...
      if (document.getElementsByClassName("plusIcon")[0]) {
        document.getElementsByClassName("plusIcon")[0].style.marginLeft =
          "83vw";
      }
    }

    if (document.getElementsByClassName("report-container")[0]) {
      document.getElementsByClassName("report-container")[0].style.width =
        "99vw";
      document.getElementsByClassName("report-con-boxe1")[0].style.marginLeft =
        "8vw";
      document.getElementsByClassName("report-con-boxe1")[0].style.width =
        "65vw";
      document.getElementsByClassName("report-con-boxe2")[0].style.marginLeft =
        "1vw";
    }

    if (document.getElementById("manager-container")) {
      document.getElementById("manager-container").style.justifyContent =
        "space-around";
    }

    if (document.getElementById("notify-container")) {
      document.getElementById("notify-container").style.marginLeft = "10vw";
      document.getElementById("notify-container").style.width = "80vw";
      document.getElementsByClassName("search-table")[0].style.marginLeft =
        "21vw";
    }

    if (document.getElementsByClassName("layout3")[0]) {
      document.getElementsByClassName("layout3")[0].style.width = "100vw";
      document.getElementsByClassName("Submit_buttons")[0].style.marginRight =
        "12vw";
    }
        ...
        <nav id="sidebarMenu" className="col-md-3 col-lg-2 d-md-block">
          ...
          <div className=" all-side-items">
            <ul className="nav flex-column">
              ...
              {/* <li className="nav-item">
                <Link className="nav-link" to="WarehouseForm">
                  <i
                    id="sidebar-logos"
              ...
              <ul>
                <div className="dropOrdersClass">
                  <div id="dropOrders">
                    {!username.includes("CWM") && (
                      <>
                        <Link to="your-order" className="nav-link">
                          <li>Your Order</li>
                        </Link>
                        <Link to="make-order" className="nav-link">
                          <li>Make Order</li>
                        </Link>
                      </>
                    )}

                    {!username.includes("OT") && (
                      <>
